        ...
        <div
            ...
            <div>
                ...
                More free & Premium templates <span aria-hidden="true"
                    ...
                    <p
                        ...
                        Obtenez votre lettre de motivation parfaite en quelques secondes
                    </p>
                    <p class="text-slate-500 lg:text-xl max-w-2xl mt-4 mx-auto text-base">
                        Générez des lettres de motivation professionnelles en quelques clics grâce à notre IA. Fini
                        les heures passées à écrire, notre générateur de lettres de motivation vous offre un service
                        rapide et efficace pour décrocher l'emploi de vos rêves.
                    </p>
                </div>
                ...
                <dl
                    ...
                    <div class="text-slate-500">
                        ...
                        >Astro, Tailwind CSS and Alpine.js</strong
                        > ━ This are the popular technologies behind Astrosaas.
                    </div>
                    <div class="text-slate-500">
                        <strong class="text-slate-700">Includes 6 pages</strong> ━ You will find
                        this landing, faq, terms,privacy,sign up and sign in pages.
                    </div>
                    <div class="text-slate-500">
                        <strong class="text-slate-700">Different section</strong> ━ The starter
                        includes different feature sections, a pricing table, testmionial, CTA
                        and full forms. more.
                    </div>
                </dl>
            </div>
            <div class="relative w-full mx-auto max-w-7xl items-center py-12 pb-12">
                <div class="bg-slate-100 p-8 rounded-3xl" style="">
                    <img
                        alt=""
            ...
            <div class="grid grid-cols-2 gap-0.5 lg:mt-8 md:grid-cols-6 mt-6">
                <div class="flex justify-center col-span-1 px-8">
                    <img alt="logo" class="max-h-12" src="/Figma.svg"/>
                </div>
                <div class="flex justify-center col-span-1 px-8">
                    <img alt="logo" class="max-h-12" src="/Canva.svg"/>
                </div>
                <div class="flex justify-center col-span-1 px-8">
                    <img alt="logo" class="max-h-12" src="/Stripe.svg"/>
                </div>
                <div class="flex justify-center col-span-1 px-8">
                    <img alt="logo" class="max-h-12" src="/Gitlab.svg"/>
                </div>
                <div class="flex justify-center col-span-1 px-8">
                    <img alt="logo" class="max-h-12" src="/Linear.svg"/>
                </div>
                <div class="flex justify-center col-span-1 px-8">
                    <img alt="logo" class="max-h-12" src="/Gumroad.svg"/>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="features">
        <div
            ...
            <div class="mx-auto max-w-2xl text-center">
                <div>
                    <p
                        class="text-black font-extrabold lg:text-5xl text-4xl tracking-tighter">
                        I am a slightly longer <span class="lg:block"
                        >heading than the others
          </span>
                    </p><p
                        class="mt-4 text-lg max-w-xl mx-auto tracking-tight text-slate-500">
                    ...
                    <h2 class="sr-only">Features.</h2><div>
                        <div
                            ...
                            <div>
                                <div>
                                    <div
                                        class="items-center justify-center text-accent-500 bg-slate-100 rounded-xl flex h-10 w-10 lg:mx-auto">
                                        <ion-icon
                                ...
                                </div><div class="mt-4 text-slate-500 text-sm">
    ...
    <section>
        <div
            ...
            <div class="mx-auto max-w-3xl lg:text-center">
                <div>
                    <p
                        ...
                        class="mt-4 text-lg max-w-xl tracking-tight text-slate-500 mx-auto">
                        If you could kick the person in the pants responsible for most of your
                        trouble, you wouldn't sit for a month
                    </p>
                </div>
            ...
            <div class="mx-auto pt-12">
                <div
                    class="mx-auto w-full gap-12 grid grid-cols-1 lg:gap-24 lg:grid-cols-3">
                    <div>
                        <div class="gap-3 lg:inline-flex lg:items-center">
                            <div
                                class="items-center justify-center text-accent-500 bg-slate-100 rounded-xl flex h-10 w-10">
                                <ion-icon
                                    aria-label="scan outline"
                                ...
                                class="mt-4 text-lg font-semibold leading-6 text-black font-display lg:mt-0">
                                Developer experience
                            </p>
                        </div><p class="text-slate-500 text-sm mt-4">
