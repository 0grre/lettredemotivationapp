...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Messages de validation en langue
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Messages de validation personnalisés en langue
    |--------------------------------------------------------------------------
    |
    ...
    | spécifier rapidement un message de langue personnalisé spécifique pour une règle d'attribut donnée.
    |
    */
    ...
    'custom' => [
        'g-recaptcha-response' => [
            'recaptchav3' => 'Captcha messaged \'erreur',
        ],
    ],
    ...
    | par quelque chose de plus explicite pour le lecteur, tel que "Adresse e-mail" au lieu de "email".
