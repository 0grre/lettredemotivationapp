<img class="w-full dark:hidden mt-4" src="{{ env('app_url') . asset('storage/undraw/undraw_add_document_re_mbjx.svg') }}" alt="dashboard image">
...
<h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Dans un premier temps.</h2>
<p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">Indique nous le job de tes rêves (ou pas) auquel tu veux postuler et le nombre d'années d'expériences.</p>
...
<form  method="post" action="{{ route('letters.create.step.job.post') }}">
    ...
    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
        <div class="sm:col-span-2">
            <label for="localization" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Le poste</label>
    ...
    <button type="submit" class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-8 text-sm font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
