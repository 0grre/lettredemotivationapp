<x-guest-layout>
    <section class="bg-cover bg-[url('https://fffuel.co/images/dddepth/dddepth-238.jpg')]">
        <section class="bg-white dark:bg-gray-900 bg-opacity-70 dark:bg-opacity-70">
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                ...
                <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    <a href="{{ route('letters.create.step.job') }}" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-600 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                        Je teste !
                        <svg class="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                    </a>
                    <a href="{{ route('login') }}" class="bg-white dark:bg-gray-900 shadow-md shadow-primary-600 inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                        S'inscrire
                    </a>
                </div>
            </div>
    ...
    <section class="bg-white dark:bg-gray-900 bg-opacity-70 dark:bg-opacity-70" id="pricing">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Des options adaptées à tous les besoins et budgets</h2>
                <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Choisissez le tarif qui vous convient le mieux parmi nos différentes options, offrant une gamme complète de fonctionnalités pour créer la lettre de motivation parfaite.</p>
            </div>
        ...
        2
        <stripe-pricing-table pricing-table-id="prctbl_1NGIkhIJlOw6AxbUyZ5rkQPU"
                              3
                              publishable-key="pk_test_51N1XRFIJlOw6AxbUf5tff7ayjHDuODrMWHQXK46878bdIBxe7lRb0QdwQJO1VUIzzJN3H8SzMqWVHoIAdw4DysHs00bFMFaztF">
            4
