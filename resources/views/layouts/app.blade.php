...
<div id="spinner" class="fixed top-0 left-0 right-0 z-[60] overflow-x-hidden h-full w-full bg-white/70 hidden flex-col justify-center">
    <div class="text-center">
        <div role="status">
            <svg aria-hidden="true" class="inline w-20 h-20 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-purple-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<section id="test" class="bg-white dark:bg-gray-900 hidden">
