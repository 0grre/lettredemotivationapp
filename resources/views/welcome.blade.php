<x-guest-layout>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Pourquoi utiliser
                    notre service de génération de lettre de motivation ?</h2>
                <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Découvrez les avantages de notre
                    plateforme et les raisons pour lesquelles vous devriez choisir notre service</p>
            </div>
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">

                <div
                    class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white reveal first">
                    <a href="#">
                    ...
                    <div class="p-5">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Des
                                exemples de lettres
                        ...
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Générez des lettres de motivation
                            professionnelles
                            ou des exemple de lettre de motivation en quelques clics grâce à notre IA alimentée avec les
                            données de Pôle Emploi.</p>
                    </div>
                </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Comment ça marche
                    ?</h2>
                ...
                <div class="mt-4 md:mt-0">
                    <ol class="relative border-l border-gray-200 dark:border-gray-700">
                        <li class="mb-10 ml-6 p-6 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 reveal first">
                            <span
                                class="absolute text-3xl flex items-center justify-center w-6 h-6 -left-3 ring-8 ring-white dark:ring-gray-900">
                             👨🏻‍💻
                            </span>
                            <h2 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Remplir le formulaire
                                en sélectionnant le métier provenant des données de Pôle Emploi</h2>
                        ...
                        <li class="mb-10 ml-6 p-6 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 reveal first">
                            ...
                            <h2 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Modifier la lettre,
                                ajouter ou retirer un paragraphe ou reformuler</h2>
                            <ul class="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
                                <li>
                                    Modifiez et adaptez la lettre de motivation générée automatiquement selon vos
                                    préférences.
                                </li>
                                <li>
                                    Intégrez des paragraphes supplémentaires ou supprimez ceux qui ne sont pas
                        ...
                        <li class="ml-6 p-6 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 reveal first">
                            ...
                            <ul class="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
                                ...
                                <li>
                                    Copiez le texte de la lettre et collez-le dans votre logiciel de traitement de texte
                                    favori pour effectuer d'autres modifications ou adaptations.
                                </li>
                            </ul>
                        </li>
                    </ol>
    ...
    <section class="background-gradient">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold leading-tight text-white animate-wiggle">Envie de
                    tester ?</h2>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Nos principales
                    fonctionnalités</h2>
                <p class="text-gray-500 sm:text-xl dark:text-gray-400">Découvrez les fonctionnalités clés qui font de
                    notre service un choix optimal pour la génération de votre lettre de motivation ou vos exemples de
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div class="reveal first">
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor" class="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Protection de la vie privée : Vos données personnelles
                        sont sécurisées grâce au cryptage avancé, garantissant la confidentialité de vos
                        informations.</p>
                </div>
                <div class="reveal second">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Respect de la confidentialité : Nous nous engageons à ne
                        jamais revendre ou partager vos données personnelles avec des tiers, assurant ainsi une
                        confidentialité totale.</p>
                </div>
                <div class="reveal third">
                    <div
                        class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor" class="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Intelligence artificielle performante : Notre service
                        utilise une IA avancée pour générer des lettres de motivation précises et adaptées à votre
                ...
                <div class="reveal third">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Données officielles fiables : Nous utilisons les données
                        officielles de Pôle Emploi pour garantir la pertinence et l'actualité des informations utilisées
                        dans la génération de votre lettre de motivation.</p>
                </div>
                <div class="reveal second">
                    <div
                        class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Personnalisation facile : Vous pouvez facilement
                        reformuler et personnaliser votre lettre de motivation générée automatiquement, en ajoutant
                        votre touche personnelle et en adaptant le contenu à vos besoins spécifiques.</p>
                </div>
                <div class="reveal first">
                    <div
                        class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Résultats de qualité : Nos lettres de motivation sont
                        conçues pour refléter un niveau de professionnalisme élevé, vous aidant à vous démarquer lors de
                        vos candidatures.</p>
                </div>
            </div>
        </div>
