<footer class="p-4 bg-white sm:p-6 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        ...
                        <li>
                            <a href="https://github.com/0grre" class="hover:underline ">Twitter</a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://github.com/0grre" class="hover:underline">0grre</a>. All Rights Reserved.
            </span>
