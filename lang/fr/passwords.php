...
return [
    ...
    | données par le gestionnaire de mots de passe pour un échec de tentative de mise à jour du mot de passe,
    | telles qu'un jeton invalide ou un nouveau mot de passe invalide.
    |
    */
