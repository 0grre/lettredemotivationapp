...
<div class="max-w-xl">
    ...
    <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">Indique nous le job de tes rêves (ou pas)
        auquel tu veux postuler, le type de contrat et le nombre d'années d'expériences.</p>
    ...
    <form method="post" action="{{ route('letters.create.step.job.post') }}">
        ...
        <div class="grid sm:grid-cols-2 gap-6">
            <div class="sm:col-span-2">
                <label for="localization" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Le
                    poste</label>
            ...
            <div class="sm:col-span-2">
                <label for="experience" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ton
                    expérience</label>
