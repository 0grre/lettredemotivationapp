<div class="hidden lg:flex items-start pt-6">
    <img class="w-full mt-6" src="{{ asset('assets/undraw/undraw_career_progress_ivdb.svg') }}" alt="dashboard image">
</div>
...
<div class="max-w-xl mx-6 lg:mx-12">
    <ol class="mb-6 flex items-center w-full text-sm font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base">
        ...
        <span class="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200 dark:after:text-gray-500">
            <span class="mr-2">2</span>Société <span class="hidden sm:inline-flex sm:ml-2">Info</span>
        </span>
        </li>
        <li class="flex items-center">
            <span class="mr-2">3</span>Nom <span class="hidden sm:inline-flex sm:ml-2">Prénom</span>
        </li>
    </ol>
    ...
    <form method="post" action="{{ route('letters.create.step.job.post') }}">
        ...
        <div class="grid sm:grid-cols-2 gap-6">
            <div class="sm:col-span-2">
                <label for="localization" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    Le poste
                </label>
            ...
            <div class="sm:col-span-2">
                <label for="contract_type" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    Type de contrat
                </label>
                <select id="contract_type" name="contract_type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
        ...
        <button type="submit" class="inline-flex items-center px-5 py-2.5 mt-8 text-sm font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
