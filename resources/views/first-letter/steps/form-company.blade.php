<div class="hidden lg:flex justify-center pt-6 mt-0 mb-auto lg:mx-12">
    <img class="mt-6" src="{{ asset('assets/undraw/undraw_interview_re_e5jn.svg') }}" alt="dashboard image">
</div>
...
<div class="max-w-xl mx-6 lg:mx-12">
    ...
    <h2 class="mb-6 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Le plus important maintenant,
        l'entreprise..</h2>
    ...
    <form method="post" action="{{ route('letters.create.step.company.post') }}" class="mt-6 space-y-6">
        ...
        <div class="sm:col-span-2">
            <label for="company" class="block mb-3 text-sm font-medium text-gray-900 dark:text-white">La société</label>
        ...
        <div class="sm:col-span-2">
            <label for="localization" class="block mb-3 text-sm font-medium text-gray-900 dark:text-white">La
                ville</label>
