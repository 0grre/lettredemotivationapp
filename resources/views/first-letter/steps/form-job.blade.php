    ...
    <form method="post" action="{{ route('letters.create.step.job.post') }}">
        ...
        <div class="grid sm:grid-cols-2 gap-6">
            ...
            <div class="sm:col-span-2">
                ...
                <select id="experience" name="experience" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" required>
