                        ...
                        <figure class="relative h-full p-6 bg-white rounded-3xl">
                            <blockquote class="relative">
                                <p class="text-base text-slate-500">
                                    ...
                                    processing, and analytics solutions for businesses and more.
                                </p>
                            </blockquote>
                            <figcaption
                                class="relative flex items-center justify-between pt-6 mt-6 border-t border-slate-100">
                                <div>
                                    <div
                        ...
                        <figure class="relative h-full p-6 bg-white rounded-3xl">
                            ...
                            <figcaption
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 text-sm text-slate-500">COO at Pff Inc</div>
                                </div>
                                <div class="overflow-hidden rounded-full bg-slate-50">
                                    <img
                                        alt=""
                        ...
                        <figure class="relative h-full p-6 bg-white rounded-3xl">
                            <blockquote class="relative">
                                <p class="text-base text-slate-500">
                                    ...
                                    expenses municipal bonds management, in the morning.
                                </p>
                            </blockquote>
                            <figcaption
                                class="relative flex items-center justify-between pt-6 mt-6 border-t border-slate-100">
