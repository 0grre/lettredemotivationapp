<header>
    <nav class="w-full fixed z-70">
        <div class="flex flex-wrap justify-between items-center mx-24 mt-6 p-6 rounded-3xl shadow-lg bg-white border border-gray-100 dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            <div class="flex items-center lg:order-2">
                ...
                @else
                    <a href="{{ route('login') }}"
                       class="hidden lg:flex text-gray-800 dark:text-white hover:bg-gray-50 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700">{{ __('Connexion') }}</a>
                    <a href="{{ route('register') }}"
                       class="hidden lg:flex text-white bg-primary-600 hover:bg-primary-700 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2">{{ __('Commencer') }}</a>
                @endauth
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    <li>
                        <a href="/#pricing"
                           class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Tarifs</a>
                    </li>
                    <li>
                        <a href="/faq"
                    ...
                    <li>
                        <a href="/#"
                           class="text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">le principe </a>
                    </li>
                    @auth
                        <li>
