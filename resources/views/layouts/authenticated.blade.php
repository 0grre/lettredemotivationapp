<x-app-layout>
    ...
    <aside
        ...
        <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
            ...
            <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                <li>
                    <!-- Modal toggle -->
                    <a id="deleteLetterButton" data-modal-toggle="deleteLetterModal"  type="button"
    ...
    <main class="md:ml-64 h-auto">
        ...
        @if(request()->routeIs('letters.show'))
            ...
            @endphp
        <!-- Main modal -->
        <div id="deleteLetterModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                ...
                <form method="post" action="{{ route('letters.delete', $id) }}">
                    ...
                    <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-900 sm:p-5">
                        <button type="button" class="text-gray-400 absolute top-2.5 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="deleteLetterModal">
                        ...
                        <p class="mb-4 text-gray-500 dark:text-gray-300">Voulez-vous vraiment supprimer votre lettre de motivation ?</p>
