<x-guest-layout>
    <section>
        <div class="flex justify-center min-h-full lg:px-0 md:px-12">
            <div class="bg-white px-4 relative flex flex-1 flex-col lg:py-24 md:flex-none md:px-28 py-10 sm:justify-center xl:py-24 z-10">
